...
function activate(context) {
	...
	let disposable1 = vscode.commands.registerCommand('color-visualizer.start', function () {
		...
		panel.webview.html = getWebviewContent("#FFFFFF", "#000000");
		globalPanel = panel
	});
...
//
			...
			if (text != "") {
				...
				globalPanel.webview.html = getWebviewContent(hex, getTextColor(hex)
...
function getWebviewContent(text, textcolorHB) {
	return `
	<!DOCTYPE html>
	<html>
	<head>
